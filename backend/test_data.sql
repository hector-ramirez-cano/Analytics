...
INSERT INTO Analytics.alert_rules (rule_id, rule_name, requires_ack, rule_definition)
    VALUES (1, 'ICMP_RTT > 500ms', TRUE, '{"is-delta-rule": false, "severity":"warning","target":1,"reduce-logic": "all","source":"facts","predicates":[{"left":"&icmp_rtt","op":"more_than","right":160, "is-delta-rule": false}]}');
